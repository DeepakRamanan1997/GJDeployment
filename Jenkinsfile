        ...
        stage('Deploy') {
            steps {
                ...
                script {
                    ...
                    sh "curl -v -u ${admin}:${admin} --upload-file ${/var/lib/jenkins/workspace/package/target/addressbook.war} ${http://3.88.230.102:9090/manager/text}/deploy?path=/Deepak&update=true"
